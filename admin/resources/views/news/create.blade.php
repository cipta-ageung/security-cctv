...
<div class="page-header">
    ...
    <ul class="breadcrumbs">
        ...
        <li class="nav-item">
            <a href="#">Tambah Berita Terbaru</a>
        </li>
    </ul>
</div>
    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-header">
                <div class="card-title">Tambah Berita Terbaru</div>
            </div>
            <form id="Validation" method="POST" action="{{ route('news.store') }}" enctype="multipart/form-data">
            @csrf
                <div class="card-body">
                    ...
                    <div class="form-group form-show-validation row">
                        ...
                        <div class="col-lg-8 col-md-9 col-sm-8">
                           <textarea id="isi_berita" name="isi_berita" class="form-control" required="">{{ old('isi_berita') }}</textarea>
                        </div>
                    ...
                    <div class="form-check">
                        <div class="row">
                            <label class="col-lg-3 col-md-3 col-sm-4 mt-sm-2 text-right">Broadcast </label>
                            <div class="col-lg-4 col-md-9 col-sm-8 d-flex align-items-center">
                                <div class="custom-control custom-checkbox">
                                    <input type="checkbox" class="custom-control-input" id="broadcast" name="broadcast">
                                    <label class="custom-control-label" for="broadcast">Sebarkan ke seluruh Pengguna</label>
                                </div>
                            </div>
                        </div>
                    </div>
