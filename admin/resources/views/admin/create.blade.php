...
<div class="row">
    <div class="col-md-12">
        <div class="card">
            ...
            <form id="Validation" method="POST" action="{{ route('admin.store') }}" enctype="multipart/form-data">
            @csrf
                <div class="card-body">
                    ...
                    <div class="form-group form-show-validation row">
                        ...
                        <div class="col-lg-4 col-md-9 col-sm-8">
                            <input type="text" class="form-control" id="name" name="name" placeholder="Nama Admin" value="{{ old('name') }}" required>
                        </div>
                        @if($errors->has('name'))
                    ...
                    <div class="form-group form-show-validation row">
                        ...
                        <div class="col-lg-4 col-md-9 col-sm-8">
                            <input type="email" class="form-control" id="email" name="email" placeholder="Email Untuk Login Ke Admin Panel" value="{{ old('email') }}" required>
                        @if($errors->has('email'))
                    ...
                    <div class="form-group form-show-validation row">
                        ...
                        <div class="col-lg-4 col-md-9 col-sm-8">
                            <input type="text" class="form-control" id="no_hp" name="no_hp" placeholder="No HP" value="{{ old('no_hp') }}" required>
                        @if($errors->has('no_hp'))
