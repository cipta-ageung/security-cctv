    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-header">
                <div class="card-title">Ubah Security</div>
            </div>
            <form id="Validation" method="POST" action="{{ route('security.update') }}" enctype="multipart/form-data">
            @csrf
                <div class="card-body">
                    ...
                    <div class="form-group form-show-validation row">
                        ...
                        <div class="col-lg-4 col-md-9 col-sm-8">
                            <input type="text" class="form-control" id="name" name="name" placeholder="Nama Security" value="{{ $find->name }}" required>
                            <input type="hidden" class="form-control" id="id" name="id" value="{{ $find->id }}" required>
                            <input type="hidden" class="form-control" id="occupant_id" name="occupant_id" value="{{ $occupant->id }}" required>
                        </div>
                        @if($errors->has('name'))
                    ...
                    <div class="form-group form-show-validation row">
                        ...
                        <div class="col-lg-4 col-md-9 col-sm-8">
                            <input type="email" class="form-control" id="email" name="email" placeholder="Email Untuk Login Ke Aplikasi" value="{{ $occupant->email }}" required>
                        @if($errors->has('email'))
                    ...
                    <div class="form-group form-show-validation row">
                        ...
                        <div class="col-lg-4 col-md-9 col-sm-8">
                            <input type="text" class="form-control" id="no_hp" name="no_hp" placeholder="No HP Security" value="{{ $occupant->no_hp }}" required>
                        @if($errors->has('no_hp'))
                    ...
                    <div class="form-group form-show-validation row">
                        ...
                        <div class="col-lg-4 col-md-9 col-sm-8">
                            <div class="input-file input-file-image">
                                @if($find->avatar)
                                <img class="img-upload-preview" width="100" height="100" src="{{ asset('penjaga/images').'/'.$find->avatar }}" alt="preview">
                                @else
