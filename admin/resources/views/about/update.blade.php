...
<div class="page-header">
    ...
    <ul class="breadcrumbs">
        ...
        <li class="nav-item">
            <a href="#">Ubah Tentang Aplikasi</a>
        </li>
    </ul>
</div>
    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-header">
                <div class="card-title">Ubah Tentang Aplikasi</div>
            </div>
            <form id="Validation" method="POST" action="{{ route('about.update') }}" enctype="multipart/form-data">
            @csrf
                <div class="card-body">
                    <div class="form-group form-show-validation row">
                        ...
                        <div class="col-lg-4 col-md-9 col-sm-8">
                            ...
                            <input type="text" class="form-control" id="nama" name="nama" placeholder="Nama" value="{{ old('nama', $find->nama) }}" required>
                        </div>
                        @if($errors->has('nama'))
...
<!--                     
                    <div class="form-group form-show-validation row">
                        ...
                        <div class="col-lg-4 col-md-9 col-sm-8">
                            <div class="input-file input-file-image">
                                <img class="img-upload-preview" width="200" height="100" src="{{ asset('produk/images/').'/'.$find->gambar }}" alt="preview">
                    ...
                    <div class="form-group form-show-validation row">
                        ...
                        <div class="col-lg-8 col-md-9 col-sm-8">
                           <textarea name="deskripsi" class="form-control" required="">{{ old('deskripsi', $find->deskripsi) }}</textarea>
                        </div>
