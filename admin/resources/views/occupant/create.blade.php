...
<div class="row">
    <div class="col-md-12">
        <div class="card">
            ...
            <form id="Validation" method="POST" action="{{ route('occupant.store') }}" enctype="multipart/form-data">
            @csrf
                <div class="card-body">
                    <div class="form-group form-show-validation row">
                        ...
                        <div class="col-lg-4 col-md-9 col-sm-8">
                            <select class="form-control" id="product_id" name="product_id" required>
                                ...
                                <option value="{{ $data->id }}" {{ old('product_id') == $data->id ? 'selected=""' : '' }}>{{ $data->nama }}</option>
                                @endforeach
                            </select>
                    ...
                    <div class="form-group form-show-validation row">
                        ...
                        <div class="col-lg-2 col-md-3 col-sm-8">
                            <input type="text" class="form-control" id="no_rumah" name="no_rumah" placeholder="Nomor Rumah" value="{{ old('no_rumah') }}" required>
                    ...
                    <div class="form-group form-show-validation row">
                        ...
                        <div class="col-lg-4 col-md-9 col-sm-8">
                            <input type="text" class="form-control" id="nama_kk" name="nama_kk" placeholder="Nama Penghuni" value="{{ old('nama_kk') }}" required>
                    ...
                    <div class="form-group form-show-validation row">
                        ...
                        <div class="col-lg-4 col-md-9 col-sm-8">
                            <input type="text" class="form-control" id="no_hp" name="no_hp" placeholder="0878xx246xx4" value="{{ old('no_hp') }}" required>
                        @if($errors->has('no_hp'))
                    ...
                    <div class="form-group form-show-validation row">
                        ...
                        <div class="col-lg-4 col-md-9 col-sm-8">
                            <div class="input-file input-file-image">
                                ...
                                <input type="file" class="form-control form-control-file" id="avatar" name="avatar" accept=".jpg,.png,.jpeg" required>
                    ...
                    <div class="form-group form-show-validation row">
                        ...
                        <div class="col-lg-4 col-md-9 col-sm-8">
                            <input type="email" class="form-control" id="email" name="email" placeholder="email@email.com" value="{{ old('email') }}" required>
                        @if($errors->has('email'))
