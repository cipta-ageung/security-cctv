        ...
        <div class="card">
            <div class="card-header">
                <div class="d-flex align-items-center">
                    <h4 class="card-title">Fasilitas {{$getProduct->nama}}</h4>
                    <a href="{{ route('facilities.create', ['id' => $getProduct->id ]) }}" class="btn btn-primary btn-round ml-auto">
