    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-header">
                <div class="card-title">Ubah CCTV</div>
            </div>
            <form id="Validation" method="POST" action="{{ route('cctv.update') }}" enctype="multipart/form-data">
            @csrf
                <div class="card-body">
                    ...
                    <div class="form-group form-show-validation row">
                        ...
                        <div class="col-lg-4 col-md-9 col-sm-8">
                            <input type="text" class="form-control" id="nama_cctv" name="nama_cctv" placeholder="Nama CCTV" value="{{ $find->nama_cctv }}" required>
                    ...
                    <div class="form-group form-show-validation row">
                        ...
                        <div class="col-lg-8 col-md-9 col-sm-8">
                           <textarea id="link_stream" name="link_stream" class="form-control" placeholder="Link Streaming RTSP" required="">{{ $find->link_stream }}</textarea>
                        </div>
