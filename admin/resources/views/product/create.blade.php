...
<div class="row">
    <div class="col-md-12">
        <div class="card">
            ...
            <form id="Validation" method="POST" action="{{ route('product.store') }}" enctype="multipart/form-data">
            @csrf
                <div class="card-body">
                    <div class="form-group form-show-validation row">
                        ...
                        <div class="col-lg-4 col-md-9 col-sm-8">
                            <input type="text" class="form-control" id="nama" name="nama" placeholder="Nama Product" value="{{ old('nama') }}" required>
                        </div>
                        @if($errors->has('nama'))
                    ...
                    <div class="form-group form-show-validation row">
                        ...
                        <div class="col-lg-8 col-md-9 col-sm-8">
                           <textarea id="lokasi" name="lokasi" class="form-control" required="">{{ old('lokasi') }}</textarea>
                        </div>
                    ...
                    <div class="form-group form-show-validation row">
                        ...
                        <div class="col-lg-3 col-md-9 col-sm-8">
                            <div class="input-file input-file-image">
                                ...
                                <input type="file" class="form-control form-control-file" id="brosur_1" name="brosur_1" accept=".jpg,.png,.jpeg" required>
                    ...
                    <div class="form-group form-show-validation row">
                        ...
                        <div class="col-lg-4 col-md-9 col-sm-8">
                            <div class="input-file input-file-image">
                                <img class="img-upload-preview" width="200" height="300" src="https://placehold.it/200x300" alt="preview">
                                <input type="file" class="form-control form-control-file" id="master_plan" name="master_plan" accept=".jpg,.png,.jpeg" required>
                    ...
                    <div class="form-group form-show-validation row">
                        ...
                        <div class="col-lg-8 col-md-9 col-sm-8">
                           <textarea id="video" name="video" class="form-control" required="">{{ old('video') }}</textarea>
                        </div>
                        @if($errors->has('video'))
